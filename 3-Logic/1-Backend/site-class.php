...
Timber::$dirname = array(
	...
	'1-Templating/3-Templates',
	'1-Templating/3-Templates/Archives',
	'1-Templating/3-Templates/CustomPostTypes',
	'1-Templating/3-Templates/Other',
	'1-Templating/3-Templates/Pages',
	'1-Templating/3-Templates/Posts',

);

// If Timber isn't activated - error message
...
class BraceWP extends TimberSite {
	...
	function add_to_context( $context ) {
		...
		// Logo
		$context['logo_image_large'] = new TimberImage(58);
		$context['logo_image_medium'] = new TimberImage(58);
		$context['logo_image_small'] = new TimberImage(58);
